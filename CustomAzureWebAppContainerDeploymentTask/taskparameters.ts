...
export class TaskParametersUtility {
    ...
    public static async getParameters(): Promise<TaskParameters> {
        var taskParameters: TaskParameters = {
            ...
            UseLinuxContainer: tl.getBoolInput('useLinuxContainer', false)
        };
        ...
        // Override isLinuxContainerApp based on useLinuxContainer parameter if provided
        if (taskParameters.UseLinuxContainer !== undefined) {
            taskParameters.isLinuxContainerApp = taskParameters.UseLinuxContainer;
            // Also update OSType to match the user's choice
            taskParameters.OSType = taskParameters.UseLinuxContainer ? "Linux" : "Windows";
        } else {
